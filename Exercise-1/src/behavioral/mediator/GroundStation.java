...
public class GroundStation implements Communicator {
    private final String name;
    private final MissionMediator mediator;

    public GroundStation(String name, MissionMediator mediator) {
        this.name = name;
    ...
    public void receiveMessage(String message, String sender) {
        AppLogger.info("GroundStation " + name + " received message from " + sender + ": " + message);
    }
}
